    ...
    return(
        ...
        <div className="w-full md:w-1/2 bg-hair flex justify-center items-center py-20 md:py-32 px-4">
          <div className="max-w-md">
            ...
            <p className="mt-6 text-white text-[15px] md:text-[18px] font-thin leading-[22.96px] md:leading-[29.56px]">Join us and get customers authenticated and verified in a convenient and secure way.</p>
            <Link to="/get-access">
        ...
        <div className="w-full md:w-1/2 bg-[#99E6FF] flex justify-center items-center py-20 md:py-32 px-4">
          <div className="max-w-xl md:max-w-md">
            ...
            <p className="mt-6 text-hair text-[15px] md:text-[18px] font-thin leading-[22.96px] md:leading-[29.56px]">Join us and get customers authenticated and verified in a convenient and secure way.</p>
