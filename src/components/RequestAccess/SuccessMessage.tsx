        ...
        <div className="w-full">
            <div className="max-w-sm mx-auto flex flex-col justify-center items-center space-y-5">
                ...
                <div className="flex flex-col w-full space-y-5">
                    <button className="text-[#00ACE6] bg-white border mt-5 border-[#00ACE6] w-full py-3 rounded text-[14px] md:text-[16] font-medium">Watch demo</button>
                    <button className="text-white bg-[#00ACE6] w-full py-3 rounded text-[14px] md:text-[16] font-medium">Get App</button>
                </div>
            </div>
        </div>
    )
