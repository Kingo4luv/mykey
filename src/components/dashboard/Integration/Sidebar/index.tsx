    ...
    return(
        <aside className="w-1/4 xl:w-1/6 h-screen text-black px-6 fixed top-16 lg:top-20 left-0 py-12 space-y-12 hidden md:block" style={{background: 'linear-gradient(180deg, #008ADB 0%, #00A8B3 100%)'}}>
            <div className="px-2 2xl:px-10 space-y-10">
                ...
                <h4 className="text-white font-medium">Get started in the sand box</h4>
                <ul className="text-white text-sm">
                    ...
                    <li className="relative top-[-4px]">
                        <div className="flex space-x-8 items-center">
                            <span className={`w-4 h-4 rounded-full border border-white inline-block absolute flex-none ${["invite-team", 'api-integration','activate-account','activate-webhook'].includes(currentScreen) ? 'bg-white' : ''}`}></span>
                            <span className="whitespace-nowrap font-medium flex-none">Invite Team</span>
                        </div>
                        <div className="pb-16 border-l-2 border-white relative left-[7px] top-[-2px]"></div>
                    </li>
                    <li className="relative top-[-8px]">
                        <div className="flex space-x-8 items-center">
                            <span className={`w-4 h-4 rounded-full border border-white inline-block absolute flex-none ${['api-integration','activate-account','activate-webhook'].includes(currentScreen) ? 'bg-white' : ''}`}></span>
                            <span className="whitespace-nowrap font-medium flex-none">Activate Webhook</span>
                        </div>
                        <div className="pb-16 border-l-2 border-white relative left-[7px] top-[-2px]"></div>
                    </li>
                    <li className="relative top-[-12px]">
                        <div className="flex space-x-4 items-center">
                            <span className={`w-4 h-4 rounded-full border border-white inline-block relative flex-none ${['api-integration','activate-account'].includes(currentScreen) ? 'bg-white' : ''}`}/>
                            <span className="whitespace-nowrap font-medium flex-none">Api Integration</span>
                        </div>
                        <div className="pb-16 border-l-2 border-white relative left-[7px] top-[-2px]"></div>
                    </li>
