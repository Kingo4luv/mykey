...
const CompanyInformation = () => {
    ...
    return(
        <div className="py-6 md:py-24 max-w-lg px-4 md:px-12">
            <h3 className="text-xl mt-6 md:mt-12">Enter your company and billing details</h3>
            ...
            <div className="mt-10">
                <form className="space-y-12 w-full" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="space-y-5">
                        <h4 className="text-sm font-medium text-black">Biometric Verification Number</h4>
                        <div className="rounded-md">
                            <div className="relative">
                                <TextInput single={true} error={errors.company?.message} register={register}   id="company" label="company" name="company" type="text" required={true} placeholder="Enter your BVN" />
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div className="flex space-x-8 mt-16">
                <div className="w-40">
                    <Button text="Next" onClick={() => changeScreenHandler("billing")} />
                </div>
            </div>
        </div>
    )
